        ...
        methods:{
            async getCompany(e){
                await axios.get(`/api/companies/${this.$route.params.id}`).then(response => {
                    this.company.name = (response.data.name ? response.data.name : "");
                    ...
                    if (response.response.data.errors !== undefined) {
                        ...
                        var message = 'Something went wrong while fetching company';
            ...
            async update(e){
                ...
                await axios.post(`/api/companies/${this.$route.params.id}`, this.company, config).then(response => {
                    $('#flash-message').html('');
                    ...
                    if (response.response.data.errors !== undefined) {
                        ...
                        var message = 'Something went wrong while updating company';
